...
insert into person(id,name,location,birth_date) values (10003,'jatin','delhi',sysdate());
insert into person(id,name,location,birth_date) values (10004,'shikhar','jj ',sysdate());
